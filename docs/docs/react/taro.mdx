  ...
  return (
    ...
    >
      ...
      <FormItem name='age' label='age'>
        <Input
          style={{ width: '100%' }}
          placeholder='请输入18,显示address表单项'
        />
      </FormItem>
...
export declare function Form<T = any>(
  props: FormProps<T>
...
/**布局组件 占据一整行*/
export declare const FormLayoutRows: (
  props: ViewProps
) => import('react/jsx-runtime').JSX.Element;
```
