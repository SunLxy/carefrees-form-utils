...
export interface FormListProps extends RegisterFormListOptions {
  children: (options: FormListChildrenProps, instances: { ruleInstance: RuleInstanceBase, formItemInstance: FormItemInstanceBase, formListInstance: FormListInstanceBase }) => React.ReactNode
}
...
export const FormList = (props: FormListProps) => {
  ...
  return <FormListInstanceContext.Provider value={formListInstance}>
...
export const FormHideList = (props: FormListProps) => {
